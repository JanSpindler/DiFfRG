...
function(rapids_cpm_run_git_patch file issue require)
  ...
  if(result EQUAL 0)
    list(APPEND msg_state "rapids-cmake [fmt]: applied ${ext} ${file_name} to fix issue: '${issue}'\n")
  else()
    list(APPEND ${error_msg_var} "rapids-cmake [fmt]: failed to apply ${ext} ${file_name}\n")
    list(APPEND ${error_msg_var} "rapids-cmake [fmt]: git ${ext} output: ${repo_error_info}\n")
  endif()
  set(msg_state ${msg_state} PARENT_SCOPE)
...
set(files "/home/nikolas/masterthesis/DiFfRG/Nikolas/QuarkMesonDiquarkComplexPotential/build/_deps/rapids-cmake-src/rapids-cmake/cpm/patches/fmt/fix_11_0_2_unreachable_loop.diff")
set(issues "fmt 11.0.2 produces a warning about an unreachable loop when compiled with nvcc")
set(required "FALSE")
set(output_file "/home/nikolas/masterthesis/DiFfRG/Nikolas/QuarkMesonDiquarkComplexPotential/build/rapids-cmake/patches/fmt/log")
set(error_file "/home/nikolas/masterthesis/DiFfRG/Nikolas/QuarkMesonDiquarkComplexPotential/build/rapids-cmake/patches/fmt/err")
